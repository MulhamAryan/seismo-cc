 ...
 * entre transports : la CLI (bin/impact.js) ET le serveur MCP seismo-impact
...
function run(opts = {}) {
  ...
  // Indices d'historique seismo-memory : ADVISORY seulement. Calculés APRÈS le
...
/**
 * Alimente seismo-memory à partir des commits de revert récents. Orchestration
